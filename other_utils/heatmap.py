...
def save_heatmap(feature_map_np, save_dir='D:\deep_learning\ISDNet-main\heatmap', filename="heatmap.png", channel=0):
    # 选择一个通道进行可视化
...
def save_image(data,filename,save_dir='D:\deep_learning\ISDNet-main\heatmap'):
    # data=data.squeeze(0)
    data=data*255/2
