...
class SpNetV2(RefineBaseDecodeHead):
    def __init__(self, shape,**kwargs):
        super(SpNetV2,self).__init__(**kwargs)
        self.shape = shape

        self.spconv1=spconv.SparseSequential(
            spconv.SubMConv2d(in_channels=5,out_channels=32,kernel_size=3,indice_key="subm0"),
            nn.BatchNorm1d(32),
            nn.ReLU(),)
        self.spconv2=spconv.SparseSequential(
...
#           )
#         self.spconv4=spconv.SparseSequential(
#             spconv.SubMConv2d(128, 256, 3, indice_key="subm0"),
#             nn.BatchNorm1d(256),
#             nn.ReLU(),
#           )
#         self.spconv5=spconv.SparseSequential(
#             spconv.SubMConv2d(256, 512, 3, indice_key="subm0"),
#             nn.BatchNorm1d(512),
#             nn.ReLU(),
#           )
#         self.spconv6=spconv.SparseSequential(
#             spconv.SubMConv2d(512, 256, 3, indice_key="subm0"),
#             nn.BatchNorm1d(256),
#             nn.ReLU(),
#           )
#         self.spconv7=spconv.SparseSequential(
#             spconv.SubMConv2d(256, 128, 3, indice_key="subm0"),
#             nn.BatchNorm1d(128),
#             nn.ReLU(),
#           )
#         self.spconv8=spconv.SparseSequential(
#             spconv.SubMConv2d(128, 64, 3, indice_key="subm0"),
#             nn.BatchNorm1d(64),
#             nn.ReLU(),
#           )
#         self.spconv9=spconv.SparseSequential(
#             spconv.SubMConv2d(64, 32, 3, indice_key="subm0"),
#             nn.BatchNorm1d(32),
#             nn.ReLU(),
#           )
#         self.spconv10=spconv.SparseSequential(
#             spconv.SubMConv2d(32, self.num_classes, 3, indice_key="subm0"),
#             # nn.BatchNorm1d(64),
#             # nn.ReLU(),
#           )
