...
import time
from .pid import BasicBlock, Bottleneck, segmenthead, DAPPM, PAPPM, PagFM, Bag, Light_Bag,AddFuse,HarrFusion,ConcatFuse
...
class PIDNet(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.augment:
            ...
            return [x_extra_p, x_ ,fusion,feats]
        else:
            return x_
