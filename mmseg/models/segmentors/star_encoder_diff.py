...
class StarEncoderDiff(EncoderDecoder):
    ...
    def __init__(self,
        ...
        super(StarEncoderDiff, self).__init__(
            backbone=backbone,
    ...
    def encode_decode(self, img, img_metas):
        ...
        diff_map = self.diff_head.forward_test_diff(prev_outputs, img_metas, self.test_cfg)
