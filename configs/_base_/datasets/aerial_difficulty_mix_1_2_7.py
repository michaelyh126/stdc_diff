# dataset settings
custom_imports = dict(
    imports=['mmseg.datasets.aerial_difficulty_compose_dataset'],
    allow_failed_imports=False)

dataset_type = 'AerialDifficultyComposeDataset'
val_dataset_type = 'InriaAerialDataset'

data_root = '/root/autodl-tmp/aerial'
difficulty_data_root = '/root/autodl-tmp/aerial_500_difficulty'
